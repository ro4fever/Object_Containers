...
import containers.HobbyAddress;
...
public class Person {
    ...
    private List<HobbyAddress> hobbyAddressList = new ArrayList<>();
    ...
    public void addNewHobbyAddress(String hobbyName, int inputFrequency, String address) {
        hobbyAddressList.add(new HobbyAddress(hobbyName, inputFrequency, address));
    }

    public static void printCertainPerson (HashMap<Person, List<HobbyAddress>> info, String name) {
    ...
    public List<HobbyAddress> getHobbyAddressList() {
